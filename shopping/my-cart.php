		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-sub-total item">Giá trên từng đơn vị</th>
					<th class="cart-sub-total item">Hình thức thanh toán</th>
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "VND"." ".$row['productPrice']; ?></span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "VND"." ".$row['shippingCharge']; ?></span></td>
