...
<html lang="en">
	<head>
	    ...
	    <title>GymShopper Home Page</title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">giao hàng miễn phí với đơn hàng trên  600,00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Tất cả các mặt hàng - giảm giá lên tới 20% </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">WHEY PROTEIN</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All</a></li>
					<li><a href="#books" data-toggle="tab">Whey Protein</a></li>
					<li><a href="#furniture" data-toggle="tab">Protein Thực Vật</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					Giá.<?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">Giá.<?php echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>
		...
		<?php if($row['productAvailability']=='In Stock'){?>
				...
				<?php } else {?>
						<div class="action" style="color:red">Còn hàng</div>
					<?php } ?>
			</div><!-- /.product -->
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Tăng Sức Mạnh</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Sữa tăng cân</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Dinh dưỡng chạy bộ</h3>
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													Giá. <?php echo htmlentities($row['productPrice']);?>
												</span>
